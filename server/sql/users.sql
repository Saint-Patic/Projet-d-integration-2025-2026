...
-- Met à jour les infos de base (prenom, nom, birthdate, email)
...
-- Met à jour le mot de passe (p_password_hash doit être déjà haché)
...
-- Met à jour des champs du profil (poids/taille/pointure/main dominante/pseudo/photo)
...
-- Changer le type d'utilisateur (playeronly / coach)
