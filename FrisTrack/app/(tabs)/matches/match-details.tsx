				...
				{showSavedTerrains && (
					<View style={styles.terrainsPicker}>
						...
						{loadingServerTerrains ? (
							...
							(() => {
								const list =
									serverTerrains && serverTerrains.length > 0 ? serverTerrains : savedTerrains;
								if (!list || list.length === 0) {
									return (
										<ThemedText style={[styles.metaText, { color: theme.text }]}>
											Pas de terrains sauvegardés
										</ThemedText>
									);
								}
								return (
									<ScrollView style={{ width: "100%", maxHeight: 160 }}>
										{list.map((t: any) => (
											<View
												...
												style={[
													styles.terrainItem,
													selectedTerrainId === t.id && styles.terrainSelected,
												]}
											>
												<View style={{ flex: 1 }}>
														...
														<TouchableOpacity
															onPress={() => {
																Alert.alert(
																	...
																	"Voulez-vous supprimer ce terrain local ?",
																	[
																		{ text: "Annuler", style: "cancel" },
																		{
																			text: "Supprimer",
																			style: "destructive",
																			onPress: () => deleteTerrain(t.id),
																		},
																	]
																);
															}}
																		...
																		{ text: "Annuler", style: "cancel" },
																		{
																			...
																			onPress: async () => {
																				try {
																					...
																					if (selectedTerrainId === t.id.toString())
