...
export default function NotificationsScreen() {
	...
	const [notifications, setNotifications] = useState<Notification[]>([
		...
		},
		{
			...
			message: "Félicitations ! Vous avez atteint une vitesse de 85 km/h, votre nouveau record !",
		...
		},
		{
			...
			message: "La connexion avec votre capteur a été interrompue. Vérifiez la portée Bluetooth.",
		...
		},
		{
			...
			message: "Votre capteur nécessite un recalibrage pour maintenir la précision des mesures.",
		...
		},
		{
			...
			message: "Toutes vos données d'entraînement ont été synchronisées avec succès.",
		...
		},
		{
			...
			message: "Le capteur a rencontré une erreur. Redémarrez l'appareil et reconnectez-le.",
		...
		<>
						...
						{notifications.length === 0 ? (
							<View style={styles.emptyContainer}>
								<Ionicons
									...
									style={{ opacity: 0.5 }}
								/>
								<ThemedText style={[styles.emptyText, { color: theme.text, opacity: 0.7 }]}>
									Aucune notification
								</ThemedText>
							</View>
						) : (
								...
								{notifications.map((notification) => (
									...
									>
										<View style={styles.notificationContent}>
											...
											<ThemedText
												style={[styles.notificationMessage, { color: theme.text, opacity: 0.8 }]}
											>
			...
			{showHeaderMenu && (
				...
				>
					...
					<TouchableOpacity style={styles.menuItem} onPress={clearAllNotifications}>
						<Ionicons name="trash-outline" size={20} color="#e74c3c" />
						<ThemedText style={[styles.menuText, { color: "#e74c3c" }]}>Effacer tout</ThemedText>
					</TouchableOpacity>
				</View>
			)}
		</>
