...
export default function SettingsScreen() {
	const { theme, isDarkMode, selectedColor, setIsDarkMode, setSelectedColor } = useTheme();
	...
	return (
		<ScreenLayout title="Paramètres" headerLeft={<BackButton theme={theme} />} theme={theme}>
			<View style={[styles.container, { backgroundColor: theme.background }]}>
				...
				>
					<ThemedText style={[styles.sectionTitle, { color: theme.text }]}>Apparence</ThemedText>
				...
				>
					...
					<View style={styles.colorPreviewContainer}>
						...
						<ThemedText style={[styles.colorPreview, { color: theme.textSecondary }]}>
