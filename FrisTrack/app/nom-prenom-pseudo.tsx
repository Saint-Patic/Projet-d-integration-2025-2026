	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.form}>
				...
				{nomError !== "" && <ThemedText style={styles.fieldErrorText}>{nomError}</ThemedText>}
				...
				{prenomError !== "" && <ThemedText style={styles.fieldErrorText}>{prenomError}</ThemedText>}
				...
				<View style={styles.inputContainer}>
					<TextInput
						...
						autoCapitalize="none"
					/>
					{pseudo !== "" && renderValidationIcon(pseudoError, pseudoAvailable, checkingPseudo)}
				</View>
				{pseudoError !== "" && <ThemedText style={styles.fieldErrorText}>{pseudoError}</ThemedText>}
